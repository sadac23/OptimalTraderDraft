...
//public abstract class AssetInfo_old
//{
//    protected IExternalSourceUpdatable updater;
//    protected IOutputFormattable formatter;

//    protected AssetInfo_old(WatchList.WatchStock watchStock)
//    {
...
//        this.ScrapedPrices = new List<AssetInfo_old.ScrapedPrice>();
//        this.FullYearPerformances = new List<AssetInfo_old.FullYearPerformance>();
//        this.FullYearProfits = new List<FullYearProfit>();
//        this.QuarterlyPerformances = new List<AssetInfo_old.QuarterlyPerformance>();
//        this.FullYearPerformancesForcasts = new List<FullYearPerformanceForcast>();
//        this.ChartPrices = new List<AssetInfo_old.ChartPrice>();
//        this.Disclosures = new List<Disclosure>();
//    }

//    protected AssetInfo_old(WatchList.WatchStock watchStock, IExternalSourceUpdatable updater, IOutputFormattable formatter)
...
//    internal static AssetInfo_old GetInstance(WatchList.WatchStock watchStock)
//    {
